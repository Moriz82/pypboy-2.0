...
class Health(game.Entity):
    ...
    def __init__(self):
        ...
        #
        # # Bottom text
        # settings.FreeRobotoB[20].render_to(self.image, (7, 509), "HP 115/115", settings.bright)
        # settings.FreeRobotoB[24].render_to(self.image, (188, 513), "LEVEL 66", settings.bright)
        # settings.FreeRobotoB[20].render_to(self.image, (602, 509), "AP 90/90", settings.bright)
